...
| Industrial-standard backend controls | **2026-03-27 onboarding audit:** Repository layer pattern, OpenAPI contract, and birth-data retention/deletion policy still required before paid-report scale. **2026-03-27 update:** D1 migration bootstrap added (`migrations/`, SQL baseline, CI migration check scaffold). **Step 3 update:** repository scaffold + SQL boundary guard added (`worker/repositories/*`, `scripts/check-service-sql-boundary.sh`). Remaining focus: OpenAPI + governance + first repository-backed report endpoint. | 2026-03-27 | 2026-05-27 | D1 migrations + OpenAPI + governance SOP merged |
