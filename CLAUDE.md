...
| Industrial-standard backend controls | **2026-03-27 onboarding audit:** Repository layer pattern, OpenAPI contract, and birth-data retention/deletion policy still required before paid-report scale. **2026-03-27 updates:** D1 migration bootstrap added (`migrations/`, SQL baseline, CI migration check scaffold) and repository boundary scaffold added (`worker/repositories/*`, SQL-boundary CI check). See TODO items M/N/O. | 2026-03-27 | 2026-05-27 | D1 migrations + OpenAPI + governance SOP merged |
