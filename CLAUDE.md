...
| Industrial-standard backend controls | **2026-03-27 onboarding audit:** Repository layer pattern, OpenAPI contract, and birth-data retention/deletion policy still required before paid-report scale. **2026-03-27 update:** D1 migration bootstrap added (`migrations/`, SQL baseline, CI migration check scaffold). **2026-03-27 follow-up:** repository layer scaffold added (`worker/repositories/*`) plus no-SQL-in-services CI guardrail (`infra:services:check-sql`). See TODO items M/N/O. | 2026-03-27 | 2026-05-27 | D1 migrations + OpenAPI + governance SOP merged |
