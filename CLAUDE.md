...
| Data layer (Phase 6) | **2026-03-27 architecture review:** No persistent database. Revenue-critical data (directory, shop, report templates, transactions) needs Cloudflare D1 + R2. Bootstrap + migration + repository scaffold are in-repo; remaining: create cloud resources and commit binding IDs in `wrangler.jsonc`. See TODO items J + K. | 2026-03-27 | 2026-06-27 | D1 tables created and first API endpoint live |
