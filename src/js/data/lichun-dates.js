/**
 * Lichun Dates — Solar term boundary dates 1900–2100.
 *
 * Lichun (立春) marks the true start of the Chinese zodiac year
 * in BaZi tradition. Format: year: [month, day].
 */

export const lichunDates = {
 ...
 * @returns {number}
 */
export function getZodiacYear(year, month, day) {
